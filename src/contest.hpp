...
public:
    ...
    void c_init(EmbeddedToken embededd_token, Registry registry, name provider, uint64_t finish, name oracle, std::vector<db::endp> endpoints);
    ...
    void c_bond(EmbeddedToken embededd_token, Bondage bondage, name issuer, name provider, uint64_t contest_id, std::string specifier, uint64_t dots);

    void c_unbond(EmbeddedToken embededd_token, Bondage bondage, name issuer, name provider, uint64_t contest_id, std::string specifier, uint64_t dots);
